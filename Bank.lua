...
return send(msg.chat_id,msg.id,"*⇜ عـذراً .. لا يوجد أكـواد كشـط حاليـاً 💳*\n*⇜ راسـل (مطـور ميلا) لـ صنـع أكـواد جديـدة*","md",true)
end
end
local Texter = "\n*⇜ أكـواد الكشـط المـوجـودة في ميلا 💳 :*\n*⇜ ارسـل الامـر (كشط) والكـود*\n\n"
