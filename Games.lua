...
Bot_Name = (Redis:get(Zelzal.."Zelzal:Name:Bot") or "ميلا")
...
if ban.id == 5571722913 or ban.id == 5571722913 then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم عمك*',"md",true)
elseif ban.id == 6669024587 then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم عمك*',"md",true)
elseif ban.id == 6669024587 then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم عمك*',"md",true)
elseif ban.id == 6669024587 then
...
elseif UserInfo.id == 5571722913 then
...
KlamSpeeddd = {"ديل","زيتون","بن تن","ون بيس","نمله","توت","دكتور","باونتي","عسل","سابق ولاحق","دماغ","خروف","ميكي ماوس","كرسي","كيا","عين","بي ام دبليو","بشت","لاما","ببجي","سيمبا","سبونج بوب","شاي","طبله","كابتن ماجد","اليابان","بزر","ديك رومي","لاكوست","نوكيا","بطه","غوريلا","باب","كراش","لوتس","فرشه","اسعاف","تركيا","تشيلسي","طرزان","ال جي","نوتيلا","طفايه","عدنان ولينا","فتيات القوه","دمعه","قراند","قطط","سله","فلاش","يد","كبد","الصين","مكسرات","فيمتو","باباي","كاميم","مسجد","برايه","بطوط","باندا","كيندر","طياره","سنافر","الصين","سالي","بطريق","قرد","شاورما","ثريه","ميداليه","ماعز","سرير","هدى","بطاريه","احلام","نيسان","لابتوب","نسر","مسدس","مسواك","بير","قوقل","ملعب","دبابه","مغسله","سلم","دبور","كودو","بيانو","كهف","مشط","نقار الخشب","تفاح","طاوله","عنكبوت"};
name = KlamSpeeddd[math.random(#KlamSpeeddd)]
...
if msg.sender_id.user_id == 5571722913 or msg.sender_id.user_id == 5571722913 or msg.sender_id.user_id == 5571722913 then
return send(msg_chat_id,msg_id,'*- يـايمـه انتـه العشـق مالـي زلــزال الهيبـه 💞😻*',"md",true) 
elseif msg.sender_id.user_id == 5571722913 then
...
hazrwinerid = Redis:get(Zelzal.."hazrwinerid"..msg.chat_id) or 5571722913
